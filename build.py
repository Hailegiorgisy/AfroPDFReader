...
<body>
    ...
    <div id="main-container">
        ...
        <div id="pdf-viewport">
            <div id="empty-state" class="welcome-card">
                <h1 class="welcome-title">Welcome to AfroPDFReader</h1>
                <p class="welcome-subtitle">This is a locally prepared PDF reader.</p>
                <button class="icon-btn primary" onclick="openPdfFile()">📂 Choose a PDF File</button>
            </div>
